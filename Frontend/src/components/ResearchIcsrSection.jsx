            ...
            <>
              <div style={{
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                  ...
                  <div className="metric-value" style={{ color: 'white' }}>{formatNumber(summary.total_projects)}</div>
              ...
              <div style={{
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                  ...
                  <div className="metric-value" style={{ color: 'white' }}>{formatNumber(summary.funded_projects)}</div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginTop: '8px' }}>
                    <span style={{ width: '6px', height: '6px', background: '#4ade80', borderRadius: '50%' }} />
              ...
              <div style={{
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                  ...
                  <div className="metric-value" style={{ color: 'white' }}>{formatNumber(summary.consultancy_projects)}</div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginTop: '8px' }}>
                    <span style={{ width: '6px', height: '6px', background: '#4ade80', borderRadius: '50%' }} />
                    <span style={{ fontSize: '13px', color: 'rgba(255,255,255,0.7)' }}>Active + Completed</span>
                  </div>
        ...
        {viewType !== 'mou' && (
          <div style={{
              ...
              {(viewType === 'projects' || viewType === 'projectsTable') && (
                <>
                  <div className="filter-group">
                    ...
                    <select value={filters.department} onChange={(e) => handleFilterChange('department', e.target.value)} style={selectStyle}>
                  ...
                  <div className="filter-group">
                    ...
                    <select value={filters.project_year} onChange={(e) => handleFilterChange('project_year', e.target.value)} style={selectStyle}>
                  ...
                  <div className="filter-group">
                    ...
                    <select value={filters.project_type} onChange={(e) => handleFilterChange('project_type', e.target.value)} style={selectStyle}>
              ...
              {viewType === 'patents' && !isRestrictedUser && (
                <>
                  <div className="filter-group">
                    ...
                    <select value={filters.patent_year} onChange={(e) => handleFilterChange('patent_year', e.target.value)} style={selectStyle}>
                      <option value="All">All Years</option>
                  ...
                  <div className="filter-group">
                    ...
                    <select value={filters.patent_status} onChange={(e) => handleFilterChange('patent_status', e.target.value)} style={selectStyle}>
                      <option value="All">All Statuses</option>
            ...
            <div style={{
              ...
              backgroundColor: '#e9ecef', borderRadius: '4px', fontSize: '14px'
            }}>
          ...
          {viewType === 'patents' && !isRestrictedUser && (
            <section className="chart-section" style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                <div className="chart-header">
                  <h2 style={{ margin: '0 0 10px 0', color: '#333', display: 'flex', alignItems: 'center', gap: '10px' }}>
                    <span style={{ fontSize: '24px' }}>📝</span> Knowledge Transfer
                  </h2>
                  <p className="chart-description" style={{ color: '#666', margin: '0' }}>
